...
def animate_pendulum(n):
    ...
    p = integrate_pendulum(n, t, initial_positions=45)
    x, y = get_xy_coords(p)
    print(x)
...
def animate_pendulum_multiple(n, n_pendulums=20, perturbation=1E-6, track_length=15):
    oversample = 3
...
# anim.save('quintuple-pendulum.mp4')